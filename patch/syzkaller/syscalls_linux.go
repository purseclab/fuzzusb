...
func isSupportedSyzkall(sandbox string, c *prog.Syscall) (bool, string) {
	...
	case "syz_usb_configfs_hid", "syz_usb_configfs_hid2", "syz_usb_configfs_close":
		return true, ""
	case "syz_usb_trans0_1", "syz_usb_trans1_2", "syz_usb_trans2_3", "syz_usb_trans3_4", "syz_usb_trans4_5", "syz_usb_trans1_0", "syz_usb_trans2_1", "syz_usb_trans3_2", "syz_usb_trans4_3", "syz_usb_trans5_4":
		return true, ""
	case "syz_usb_idle":
		return true, ""
